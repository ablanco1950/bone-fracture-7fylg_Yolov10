...
But the accompanying models, such as last28Hits190epoch.pt, will give errors and must be regenerated by running:

TrainFracture-7fylg_Yolov10.py

which takes some time if you do not have a high-performance computer.
